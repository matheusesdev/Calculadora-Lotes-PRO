// Arquivo: calculadora-frontend/src/App.js (VERSÃO COM REDIRECIONAMENTO DE ABA)
...
function App() {
  ...
  const filteredLotes = useMemo(() => {
    return lotes.filter(lote => {
      ...
      const atendeBusca = !searchTerm || lote.UNIDADE.toLowerCase().includes(lowerSearch) || lote.BLOCO.toLowerCase().includes(lowerSearch) || lote.ETAPA.toLowerCase().includes(lowerSearch);
